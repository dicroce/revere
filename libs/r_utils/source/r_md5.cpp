...
void r_md5::update(const uint8_t* src, size_t size)
{
    uint32_t saved_lo;
...
void r_md5::finalize()
{
    ...
    _lo <<= 3;
    _buffer[56] = (unsigned char)_lo;
    _buffer[57] = (unsigned char)(_lo >> 8);
    _buffer[58] = (unsigned char)(_lo >> 16);
    _buffer[59] = (unsigned char)(_lo >> 24);
    _buffer[60] = (unsigned char)_hi;
    _buffer[61] = (unsigned char)(_hi >> 8);
    _buffer[62] = (unsigned char)(_hi >> 16);
    _buffer[63] = (unsigned char)(_hi >> 24);

    _body(_buffer, 64);

    _result[0] = (uint8_t)_a;
    _result[1] = (uint8_t)(_a >> 8);
    _result[2] = (uint8_t)(_a >> 16);
    _result[3] = (uint8_t)(_a >> 24);
    _result[4] = (uint8_t)_b;
    _result[5] = (uint8_t)(_b >> 8);
    _result[6] = (uint8_t)(_b >> 16);
    _result[7] = (uint8_t)(_b >> 24);
    _result[8] = (uint8_t)_c;
    _result[9] = (uint8_t)(_c >> 8);
    _result[10] = (uint8_t)(_c >> 16);
    _result[11] = (uint8_t)(_c >> 24);
    _result[12] = (uint8_t)_d;
    _result[13] = (uint8_t)(_d >> 8);
    _result[14] = (uint8_t)(_d >> 16);
    _result[15] = (uint8_t)(_d >> 24);
}

void r_md5::get(uint8_t* output)
{
    if(!_finalized)
