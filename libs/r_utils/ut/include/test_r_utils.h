...
public:
    RTF_FIXTURE(test_r_utils);
      ...
      TEST(test_r_utils::test_blob_tree_reject_truncated_header);
      TEST(test_r_utils::test_blob_tree_reject_bad_magic);
      TEST(test_r_utils::test_blob_tree_reject_bad_node_type);
      TEST(test_r_utils::test_blob_tree_reject_truncated_field);
      TEST(test_r_utils::test_blob_tree_reject_giant_leaf_len);
      TEST(test_r_utils::test_blob_tree_reject_giant_array_count);
      TEST(test_r_utils::test_blob_tree_reject_giant_object_count);
      TEST(test_r_utils::test_blob_tree_reject_deep_nesting);
      TEST(test_r_utils::test_blob_tree_valid_still_roundtrips);
    ...
    void test_blob_tree_reject_truncated_header();
    void test_blob_tree_reject_bad_magic();
    void test_blob_tree_reject_bad_node_type();
    void test_blob_tree_reject_truncated_field();
    void test_blob_tree_reject_giant_leaf_len();
    void test_blob_tree_reject_giant_array_count();
    void test_blob_tree_reject_giant_object_count();
    void test_blob_tree_reject_deep_nesting();
    void test_blob_tree_valid_still_roundtrips();
