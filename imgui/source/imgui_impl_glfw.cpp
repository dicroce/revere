...
struct ImGui_ImplGlfw_Data
{
    ...
    GLFWwindowrefreshfun    PrevUserCallbackWindowRefresh;
...
void ImGui_ImplGlfw_WindowRefresh(GLFWwindow* window)
{
//
//
}
...
void ImGui_ImplGlfw_InstallCallbacks(GLFWwindow* window)
{
    ...
    bd->PrevUserCallbackWindowRefresh = glfwSetWindowRefreshCallback(window, ImGui_ImplGlfw_WindowRefresh);
...
void ImGui_ImplGlfw_RestoreCallbacks(GLFWwindow* window)
{
    ...
    glfwSetWindowRefreshCallback(window, bd->PrevUserCallbackWindowRefresh);
